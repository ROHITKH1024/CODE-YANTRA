...
const GEMINI_API_KEY = 'AIzaSyBJagkGw5-i2AMZYSVBGgGyO71LB_9X3u0';
const DebugCode = ({ code, onClose }) => {
  ...
  useEffect(() => {
    ...
    const generateExplanation = async () => {
      setIsLoading(true);
      try {
        const prompt = `Debug the provided code and list out the errors pointwise if any:\n\n${code}`;
    ...
    <div className="fixed inset-0 flex items-center justify-center bg-black bg-opacity-50 z-50">
      <div className="bg-neutral-800 rounded p-4 max-w-xl mx-auto">
        <div className="flex justify-between items-center mb-4">
          <h2 className="text-2xl font-bold text-white">Debugging Code</h2>
          <button
